  ...
  return (
    <>
      <div className={"ap-root" + (isNarrow ? " is-narrow" : "")}>
        <Stage rig={rig} plane={plane} angles={angles} pos={pos} dir={dir} descs={descs} layer={layer}
          selected={stageSelected} selectedJointId={selectedJointId} chains={CHAINS[plane]} fingerCurl={fingerCurl}
          dispatch={dispatch} isNarrow={isNarrow} />
        <Panel state={state} dispatch={dispatch} rig={rig} otherRig={otherRig} descs={descs} otherDescs={otherDescs}
          selectedJointId={selectedJointId} canUndo={canUndo(state)} canRedo={canRedo(state)} sheet={sheet} onHover={setPanelHover} />
      </div>
